...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 point123">
        ...
        <div class="col-xs-6
                    ...
                    col-lg-7
                    col-lg-offset-5">
                    <img class="img-responsive img_trois_points" src="image/atom.png" alt="" width="150px" height="200px"></div>
        <div class="hidden-xs
                    hidden-sm
                    col-md-7
                    col-md-offset-5
                    ...
                    <p>Accedat huc suavitas quaedam oportet sermonum atque morum, haudquaquam mediocre condimentum amicitiae. Tristitia autem et in omni re severitas habet illa quidem gravitatem.</p></div>
    </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 point123">
        ...
        <div class="hidden-xs
            ...
            <div class="hidden-xs hidden-sm col-md-2 col-lg-2"></div></div> <!--- espace --->
        ...
        <div class="hidden-xs
                    ...
                    <div class="hidden-xs hidden-sm col-md-2 col-lg-2"></div></div>
    </div>
