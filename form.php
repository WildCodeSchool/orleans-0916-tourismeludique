<div class="sectionForm" id="ancreForm">
    <div class="row">
        <div class="col-lg-1 hidden-xs hidden-sm hidden-md titreContact">
            <h1>Contactez-nous</h1>
        </div>
        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 leftSide">
            <p class="adresse">
            ...
            <small><a  class="legendecarte" target="_blank" href="http://www.openstreetmap.org/?mlat=47.89356&amp;mlon=1.89306#map=17/47.89356/1.89305">Ouvrir la carte dans un nouvel onglet</a></small>
        </div>
